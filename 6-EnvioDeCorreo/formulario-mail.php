...
<head>
    ...
    function validarForm() {
        var verificar = true;
        //expresion regular de email busqueda de google
        ...
        // si verificar en true y no entro a ningun error de arriba el document entra al submit
        if (verificar) {
            document.mail_frm.submit();
        }
    }
    // cuando la ventana carga lo enviamos ala funcion validarform
...
<body>
    <form name="mail_frm" action=" http://hdz.17sara@gmail.com/PHP/BASICO/6-EnvioDeCorreo/enviar-mail.php" method="post"
